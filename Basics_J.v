...
(** The [destruct] generates _two_ subgoals, which we must then
    ...
    lists_ of names, separated by [|].  In this , the first
    ...
    Marking s with bullets is optional: if bullets are not
...
(** Note that the [destruct] here has no [as] clause because
    none of the subs of the [destruct] need to bind any variables,
